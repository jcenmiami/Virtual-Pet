...
var GameState = {
      ...
      create: function() {      
        ...
        this.pet.input.enableDrag(false, false, true);
        ...
        // Decrease the health and fun in time.
      ...
      pickItem: function(sprite, event){
        ...
        if (!this.uiBlocked){
          ...
          // Clear item alpha first, then set the selected item to lower alpha.
          this.clearSelection();
      ...
      placeItem: function(sprite, event) {
        ...
        if(this.selectedItem && !this.uiBlocked){
          ...
          petMovement.onComplete.add(function(){
            ...
            newItem.destroy();
            console.log('Pet Moved towards item.');
